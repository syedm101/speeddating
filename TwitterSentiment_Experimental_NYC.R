#Speed Dating Anotated R Code, Twitter Supplement (New York City)
...
download.file(url="http://curl.haxx.se/ca/cacert.pem",
              destfile="~/Desktop/DS4559/text_mining_and_web_scraping/cacert.pem",
              method="curl")
...
# harvest some tweets
some_tweets = searchTwitter("dating", n=2000, lang="en", geocode='40.7128,-74.0059,30mi', retryOnRateLimit=120)
...
positives= readLines("~/Documents/OneDrive/UVA_2ndyr/DS4559/inclass/day15/negative_words.txt")
negatives= readLines("~/Documents/OneDrive/UVA_2ndyr/DS4559/inclass/day15/positive_words.txt")
...
classify_emotion <- function(textColumns,algorithm="bayes",prior=1.0,verbose=FALSE,...) {
  ...
  lexicon <- read.csv("~/Documents/OneDrive/UVA_2ndyr/DS4559/inclass/day15/emotions.csv",header=FALSE)
...
classify_polarity <- function(textColumns,algorithm="bayes",pstrong=0.5,pweak=1.0,prior=1.0,verbose=FALSE,...) {
  matrix <- create_matrix(textColumns,...)
  lexicon <- read.csv("~/Documents/OneDrive/UVA_2ndyr/DS4559/inclass/day15/subjectivity.csv",header=FALSE)
